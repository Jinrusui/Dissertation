#!/usr/bin/env python3
"""
Analyze and visualize results from atari_gpt experiments.
"""
...
logger = logging.getLogger("atari_gpt.analysis")

def parse_args():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description='Analyze atari_gpt experiment results')
